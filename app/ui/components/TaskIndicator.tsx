...
export const TaskIndicator = () => {
  ...
  return (
    <div className="absolute bottom-4 left-1/2 -translate-x-1/2 z-50 flex items-center gap-3 rounded-full border border-solid border-neutral-border bg-default-background px-4 py-3 shadow-lg">
