...
export const buildSchema = () => {
  ...
  return z.object({
    for: z
      ...
      .describe(`Guidance keys to load.\n\n${availableList}`),
  })
}
...
export const getGuidanceTool: AnyTool = {
  name: "get_guidance",
  description:
    "Load task-specific guidance playbooks. Index files are included automatically. Always include the project phase that matches the current state (one of the project/* keys).",
  get schema() {
    return buildSchema()
  },
}
