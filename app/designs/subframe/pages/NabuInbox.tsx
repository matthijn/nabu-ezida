      ...
      <div className="flex h-full w-full cursor-pointer items-start bg-default-background">
        <div className="flex w-72 flex-none flex-col items-start self-stretch border-r border-solid border-neutral-border bg-default-background relative">
          ...
          <div className="flex w-full flex-col items-start gap-2 border-b border-solid border-neutral-border px-4 py-4">
            ...
            <div className="flex w-full items-center gap-2 rounded-[4px] px-1 py-1.5 hover:bg-neutral-50 cursor-pointer">
          ...
          <div className="flex w-full grow shrink-0 basis-0 flex-col items-start gap-4 px-4 py-4 overflow-auto">
            ...
            <div className="flex w-full flex-col items-start gap-2">
              ...
              <div className="flex w-full items-center gap-2 rounded-md bg-[#dbeafe] px-3 py-2">
                <div className="flex h-2 w-2 flex-none items-start rounded-full bg-[#93c5fd]" />
                <span className="grow shrink-0 basis-0 text-body font-body text-default-font">
            ...
            <div className="flex w-full flex-col items-start gap-2">
              ...
              <div className="flex w-full items-center gap-2 rounded-md bg-[#fce7f3] px-3 py-2">
                <div className="flex h-2 w-2 flex-none items-start rounded-full bg-[#f9a8d4]" />
                <span className="grow shrink-0 basis-0 text-body font-body text-default-font">
              ...
              <div className="flex w-full items-center gap-2 rounded-md bg-[#ede9fe] px-3 py-2">
                <div className="flex h-2 w-2 flex-none items-start rounded-full bg-[#a78bfa]" />
                <span className="grow shrink-0 basis-0 text-body font-body text-default-font">
                  Local Resistance
                </span>
                <span className="text-caption font-caption text-subtext-color">
        ...
        <div className="flex grow shrink-0 basis-0 items-start self-stretch">
          <div className="flex grow shrink-0 basis-0 flex-col items-start self-stretch">
            ...
            <div className="flex w-full grow shrink-0 basis-0 flex-col items-start px-24 py-8 overflow-auto mobile:px-6 mobile:py-6">
              <div className="flex w-full max-w-[768px] items-start">
                <div className="flex grow shrink-0 basis-0 flex-col items-start gap-8 rounded-lg bg-white px-12 py-10 shadow-md mobile:px-6 mobile:py-6">
